...
export function resetAllCounters(): void {
  ...
  const { resetCredentialCounter } = require("./credentials.js");
  const { resetIssueCounter, resetPRCounter } = require("./issues.js");
...
Note: The resetAllCounters uses require for simplicity. Alternatively, import each reset function directly in the calling test file.
  </action>
  <verify>
