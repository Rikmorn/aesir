...
- [human-verification-items](human-verification-items.md) — #14 · 57 human-verification items across the eleven shipped milestones' phase verification reports have not been checked off.
...
- [retrieval-strategies](retrieval-strategies.md) — #23 · Three concrete retrieval strategies deferred from v2.9's pluggable pipeline — BM25 keyword, temporal decay and MMR diversity.
