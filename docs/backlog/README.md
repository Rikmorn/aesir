...
- [human-verification-items](human-verification-items.md) — #14 · 98 human-verification items, per the 2026-09-15 extract-phases.ts run, have not been checked off — see docs/history/phases.md for the live count.
