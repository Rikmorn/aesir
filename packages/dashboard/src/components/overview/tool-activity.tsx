          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b">
                <th className="sticky top-0 z-10 bg-card px-4 py-1.5 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground">
                  Tool
                </th>
                <th className="sticky top-0 z-10 bg-card px-4 py-1.5 text-right text-xs font-medium uppercase tracking-wider text-muted-foreground">
                  Calls
                </th>
                <th className="sticky top-0 z-10 bg-card px-4 py-1.5 text-right text-xs font-medium uppercase tracking-wider text-muted-foreground">
                  Errors
