/**
 * MCP Tool Permission Checker for Slack Integration
 *
 ...
 */
export async function checkSlackToolPermission(
  ...
  const childLogger = logger.child({
    component: "integrations:slack:mcp:permissions",
    agentId,
    toolName,
  });
...
export { mcpToolPermissions as SlackMcpToolPermissions };
