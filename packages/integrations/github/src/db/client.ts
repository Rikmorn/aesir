 ...
 *
 * PostgreSQL connection pool and Drizzle ORM client for GitHub package.
 * Uses GitHub-specific config and connects to github.* schema namespace.
 *
 * IMPORTANT: Database connections are LAZY - created on first access.
 * This allows importing from @aesir/integration-github without requiring DB config.
 */
