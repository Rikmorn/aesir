/**
 * MCP Tool Permission Checker for GitHub Integration
 *
 ...
 */
export async function checkGitHubToolPermission(
  ...
  const childLogger = logger.child({
    component: "integrations:github:mcp:permissions",
    agentId,
    toolName,
  });
...
export { mcpToolPermissions as GitHubMcpToolPermissions };
