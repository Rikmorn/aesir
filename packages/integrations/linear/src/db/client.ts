/**
 * Linear Database Client
 *
 * PostgreSQL connection pool and Drizzle ORM client for Linear package.
 * Uses Linear-specific config and connects to linear.* schema namespace.
 *
 * IMPORTANT: Database connections are LAZY - created on first access.
 * This allows importing from @aesir/integration-linear without requiring DB config.
 */
