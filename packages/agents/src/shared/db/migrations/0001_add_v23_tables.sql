-- v2.3 Tables Migration
-- Adds conversations, agent_events, and agent_sessions tables to the agents schema.
...
-- Updated_at triggers for new tables (agent_events is append-only, no trigger needed)
